...
namespace Support.DashBoard
{
    public partial class ucMachStates : ucVisObj
    {
        ...
        {
            get { return pictureBox_machine; }
            set { pictureBox_machine = value; }
        }
        ...
        public void Init(string mach_id)
        {
            InitializeComponent();
            base._ucChild = this;
            machine_id = mach_id;
        ...
        public override void Refresh()
        {
            ...
            try
            {
                ...
                */
                ...
                pictureBox_machine.ImageLocation = ImgFilePath + str;
                //-------------------------------------------------------------------------------------
        ...
        private void lbl_MachineName_Click(object sender, EventArgs e)
        {
