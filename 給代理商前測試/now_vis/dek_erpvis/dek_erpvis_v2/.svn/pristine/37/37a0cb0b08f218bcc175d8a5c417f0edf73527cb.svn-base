<%@ Page Title="" Language="C#" MasterPageFile="~/masterpage.Master" AutoEventWireup="true" CodeBehind="exxample_page.aspx.cs" Inherits="dek_erpvis_v2.pages.dp_PD.materialrequirementplanning" %>
      ...
      <div class="">
        <div class="page-title">
          <div class="title_left">
            <h3>範例網頁 <small> 小標題小標題 <strong>粗體粗體</strong></small></h3>
          </div>
        </div>
      </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel2"><i class="fa fa-file-text"></i> 資料檢索精靈</h4>
                </div>
                                ...
                                <div class="row">
                                        <div class="col-xs-12 col-sm-9 col-md-12 col-lg-12">
                                            <div class="btn-group btn-group-justified">
                                              <asp:LinkButton ID="LinkButton_day" runat="server" CssClass="btn btn-default active" OnClick="button_select_Click">日</asp:LinkButton>
                            ...
                            <div class="form-group">
                                    ...
                                    <div class="control-group">
                                        <div class="controls">
                                            <div class="col-md-11 xdisplay_inputx form-group has-feedback">
                                                <input type="text" class="form-control has-feedback-left" id="dt1" value="" placeholder="開始時間" aria-describedby="inputSuccess2Status1">
                                ...
                                <fieldset>
                                    <div class="control-group">
                                        <div class="controls">
                                            <div class="col-md-11 xdisplay_inputx form-group has-feedback">
                                                <input type="text" class="form-control has-feedback-left" id="dt2" value="" placeholder="結束時間" aria-describedby="inputSuccess2Status2">
                                                <span class="fa fa-calendar-o form-control-feedback left" aria-hidden="true"></span>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary antosubmit2">執行運算</button>
                </div>
            </div>
        </div>
    </div>
