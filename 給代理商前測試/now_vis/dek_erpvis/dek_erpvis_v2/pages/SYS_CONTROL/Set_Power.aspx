<%@ Page Title="" Language="C#" MasterPageFile="~/masterpage.Master" AutoEventWireup="true" CodeBehind="Set_Power.aspx.cs" Inherits="dek_erpvis_v2.pages.SYS_CONTROL.Set_Power" %>
                ...
                <div class="x_panel" id="Div_Shadow">
                    <div class="x_title" style="text-align: center">
                        ...
                        <div class="col-md-1 col-sm-6 col-xs-12">
                            <div class="col-md-12 col-sm-6 col-xs-10" align="center" style="text-align: left; display: none">
                                <asp:Button ID="Button_Open" runat="server" Text="展開" OnClick="Button_Action_Click" class="btn btn-default" />
                            </div>
                            <div class="col-md-12 col-sm-6 col-xs-2" align="center" style="text-align: left; display: none">
                            ...
                            <div class="col-md-12 col-sm-6 col-xs-12" align="center">
                                <asp:ImageButton ID="ImageButton_Shrink" runat="server" ImageUrl="../../assets/images/Shrink.png" Height="40px" Width="40px" OnClick="ImageButton_Shrink_Click" class="btn btn-default" /><br>
                            </div>
                            <div class="col-md-12 col-sm-6 col-xs-12" align="center">
                    ...
                    <div class="col-md-2 col-sm-2 col-xs-2" align="center">
                        <button id="btnclearNode" type="button" onclick="Clear_Node()" class="btn btn-danger">清除節點</button>
                        <asp:Button ID="Button_Delete" runat="server" Text="刪除節點" OnClick="Button_Delete_Click" Style="display: none" />
                    </div>
                ...
                <div class="x_panel" id="Div_Shadow">
                    <div class="x_title" style="text-align: center">
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <asp:TextBox ID="TextBox_dpm" runat="server" placeholder="請輸入群組名稱" Font-Size="18px" Width="150px"></asp:TextBox>
                            <asp:CheckBoxList ID="CheckBoxList_dpm" runat="server" RepeatColumns="4" Style="display: none"></asp:CheckBoxList>
                        </div>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <asp:Panel ID="Panel1" runat="server">
                                <div style="text-align: left;">
                                    <div style="color: white; background-color: DodgerBlue;display:<%=GroupShow[0]%>;"><b>業務部</b></div>
                                    <asp:CheckBoxList ID="CheckBoxList_SLS" runat="server" RepeatColumns="4"></asp:CheckBoxList>
                                </div>
                                <div style="text-align: left; display: <%=GroupShow[1]%>;">
                                    <div style="color: white; background-color: DodgerBlue"><b>資材部</b></div>
                                    <asp:CheckBoxList ID="CheckBoxList_PCD" runat="server" RepeatColumns="4"></asp:CheckBoxList>
                                </div>
                                <div style="text-align: left; display: <%=GroupShow[2]%>;">
                                    <div style="color: white; background-color: DodgerBlue"><b>倉管部</b></div>
                                    <asp:CheckBoxList ID="CheckBoxList_WHE" runat="server" RepeatColumns="4"></asp:CheckBoxList>
                                </div>
                                <div style="text-align: left; display: <%=GroupShow[3]%>;">
                                    <div style="color: white; background-color: DodgerBlue"><b>生產部</b></div>
                                    <asp:CheckBoxList ID="CheckBoxList_PMD" runat="server" RepeatColumns="4"></asp:CheckBoxList>
                                </div>
                                <div style="text-align: left; display: <%=GroupShow[4]%>;">
                                    <div style="color: white; background-color: DodgerBlue"><b>加工部</b></div>
                                    <asp:CheckBoxList ID="CheckBoxList_CNC" runat="server" RepeatColumns="4"></asp:CheckBoxList>
                                </div>
                                <div style="text-align: left; display: <%=GroupShow[5]%>;">
                                    <div style="color: white; background-color: DodgerBlue"><b>自動排程</b></div>
                                    <asp:CheckBoxList ID="CheckBoxList_APS" runat="server" RepeatColumns="4"></asp:CheckBoxList>
                                </div>
                                <div style="text-align: left; display: <%=GroupShow[6]%>;">
                                    <div style="color: white; background-color: DodgerBlue"><b>報工模組</b></div>
                                    <asp:CheckBoxList ID="CheckBoxList_DES" runat="server" RepeatColumns="4"></asp:CheckBoxList>
                                </div>

                            </asp:Panel>
                        </div>

                        <asp:Button ID="Button_Add" runat="server" Text="新增功能" OnClick="Button_Add_Click" class="btn btn-primary antosubmit2" />
                        <div class="clearfix"></div>
                    </div>
                </div>
            </div>
