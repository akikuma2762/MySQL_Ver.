<%@ Page Title="" Language="C#" MasterPageFile="~/masterpage.Master" AutoEventWireup="true" CodeBehind="Set_PageGroup.aspx.cs" Inherits="dek_erpvis_v2.pages.SYS_CONTROL.Set_PageGroup" %>
            ...
            <div class="col-md-6 col-sm-12 col-xs-12" style="padding-left: 5px">
                <div class="x_panel" id="Div_Shadow">
                    <div class="x_title" style="text-align: center;">
                        ...
                        <asp:Button ID="Button_dpm" runat="server" Text="新增部門" OnClick="Button_dpm_Click" class="btn btn-primary antosubmit2"  />
                        <div class="clearfix" ></div>
                        <br   />
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12" style="display: none">
                                ...
                                <asp:CheckBoxList ID="CheckBoxList_Edit" runat="server" RepeatColumns="4" style="text-align:left"></asp:CheckBoxList>
                        
                        </div>
                        <asp:Button ID="Button_Add" runat="server" Text="新增頁面" OnClick="Button_Add_Click" class="btn btn-primary antosubmit2" />
                        <div class="clearfix"></div>
                    </div>
                </div>
            </div>
