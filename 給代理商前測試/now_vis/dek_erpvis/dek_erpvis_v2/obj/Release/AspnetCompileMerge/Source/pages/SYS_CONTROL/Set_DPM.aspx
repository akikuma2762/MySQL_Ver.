<%@ Page Title="" Language="C#" MasterPageFile="~/masterpage.Master" AutoEventWireup="true" CodeBehind="Set_DPM.aspx.cs" Inherits="dek_erpvis_v2.pages.SYS_CONTROL.Set_DPM" %>
                ...
                <div class="x_panel" id="Div_Shadow">
                    <div class="x_title" style="text-align: center">
                        ...
                        <div class="col-md-12 col-sm-8 col-xs-12">
                            <asp:TextBox ID="TextBox_dpm" runat="server" placeholder="請輸入部門名稱" Font-Size="18px" Width="150px"></asp:TextBox><br/>
                            <asp:TextBox ID="TextBox_code" runat="server" placeholder="請輸入部門代號" Font-Size="18px" Width="150px"></asp:TextBox>
                        </div>
