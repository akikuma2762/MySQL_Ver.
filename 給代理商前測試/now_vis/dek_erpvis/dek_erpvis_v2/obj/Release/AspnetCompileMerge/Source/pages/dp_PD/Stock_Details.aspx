<%@ Page Title="" Language="C#" MasterPageFile="~/masterpage.Master" AutoEventWireup="true" CodeBehind="Stock_Details.aspx.cs" Inherits="dek_erpvis_v2.pages.dp_PD.Stock_Details" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title><%=itemname %> 庫存明細 | <%= WebUtils.GetAppSettings("Company_Name") %></title>
    <%=color %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script>
        //產生表格的HTML碼
        create_tablehtmlcode('Stock_Details', '<%=itemname %> 庫存明細', 'datatable-buttons', '<%=th.ToString() %>', '<%=tr.ToString()%>');
        //產生相對應的JScode
        ...
        $("#btncheck").click(function () {
            if (document.getElementById('<%=TextBox_item.ClientID%>').value != '') {
