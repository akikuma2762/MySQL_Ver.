<%@ Page Title="" Language="C#" MasterPageFile="~/masterpage.Master" AutoEventWireup="true" CodeBehind="Error_Historys.aspx.cs" Inherits="dek_erpvis_v2.pages.dp_CNC.Error_Historys" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>維護歷程搜尋 | <%= WebUtils.GetAppSettings("Company_Name") %></title>
    <%=color %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                            ...
                            <div class="x_content">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="col-md-3 col-xs-12">
                                        <button id="btnprint" type="button" class="btn btn-success" Style="display: none">列印問題</button>
                                        <asp:Button ID="Button_Print" runat="server" Text="列印問題" Style="display: none" class="btn btn-success" OnClick="Button_Print_Click" />
                                    </div>
    ...
    <script>
        ...
        //產生表格的HTML碼
        create_tablecode_noshdrow('Error_Historys', '歷史查詢', 'datatable-buttons', '<%=th.ToString() %>', '<%=tr.ToString() %>');
        //產生相對應的JScode
        ...
        //跳頁(已有參數 可直接跳)
        function jump_ErrorDetail(paramer) {
            ...
            document.location.href = "Error_Detail.aspx?key=" + paramer;
