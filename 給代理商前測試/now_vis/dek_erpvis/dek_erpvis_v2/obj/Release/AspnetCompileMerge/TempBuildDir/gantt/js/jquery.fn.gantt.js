...
(function ($, undefined) {
    ...
    $.fn.gantt = function (options) {
        ...
        var settings = {
            ...
            // localisation
            dow: ["日", "一", "二", "三", "四", "五", "六"],
            months: ["一月", "二月", "三月", "四月", "五月", "六月", "七 月", "八月", "九月", "十月", "十一月", "十二月"],
            waitText: "請稍後.....",
        ...
        var core = {
            ...
            dataPanel: function (element, width) {
                var dataPanel = $('<div class="dataPanel" style="width: ' + width + 'px;height:480px"/>');
                        ...
                        $.each(entry.values, function (j, day) {
                            ...
                            switch (settings.scale) {
                                ...
                                case "hours":
                                    ...
                                    top = cellWidth * 5 + barOffset + topEl.data("offset") + i * 24;
                                    _bar.css({
                                        top: top,
                                ...
                                case "weeks":
                                    ...
                                    // find row
                                    topEl = $(element).find("#rowheader" + i);
                                    top = cellWidth * 3 + barOffset + topEl.data("offset") + i * 24;
                                    _bar.css({
                                        top: top,
                                        left: Math.floor(cFrom),
                                        width: dp + '%'
                                ...
                                case "months":
                                    ...
                                    // find row
                                    topEl = $(element).find("#rowheader" + i);
                                    top = cellWidth * 2 + barOffset + topEl.data("offset") + i * 24;
                                    _bar.css({
                                        top: top,
                                        left: Math.floor(cFrom),
                                        width: dp + '%'
                                ...
                                default:
                                    ...
                                    // find row
                                    topEl = $(element).find("#rowheader" + i);
                                    top = cellWidth * 4 + barOffset + topEl.data("offset") + i * 24;
                                    _bar.css({
                                        top: top,
                                        left: Math.floor(cFrom),
                                        width: dp + '%'
