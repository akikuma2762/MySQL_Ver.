<%@ Page Title="" Language="C#" MasterPageFile="~/masterpage.Master" AutoEventWireup="true" CodeBehind="Asm_ResponeDepartment.aspx.cs" Inherits="dek_erpvis_v2.pages.dp_PM.Asm_ResponeDepartment" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>各部門異常統計 | <%= WebUtils.GetAppSettings("Company_Name") %></title>
    <%=color %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="right_col" role="main" style="height: 930px;">
        ...
        <!-----------------/title------------------>
        <!-----------------content------------------>
        <div id="Asm_ResponeDepartment"></div>
        <!-----------------/content------------------>
    </div>
    <%=Use_Javascript.Quote_Javascript() %>
    <script>
        //產生表格的HTML碼
        create_tablecode('Asm_ResponeDepartment', '各部門異常統計', 'datatable-buttons', '<%=th.ToString() %>', '<%=tr.ToString() %>');
        //產生相對應的JScode
