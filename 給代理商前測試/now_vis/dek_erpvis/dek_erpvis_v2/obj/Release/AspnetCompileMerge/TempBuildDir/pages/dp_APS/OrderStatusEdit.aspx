<%@ Page Title="" Language="C#" MasterPageFile="~/masterpage.Master" AutoEventWireup="true" CodeBehind="OrderStatusEdit.aspx.cs" Inherits="dek_erpvis_v2.pages.dp_APS.OrderStatusEdit" %>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel" id="Div_Shadow">
                    <div class="x_content">
                        ...
                        <br>
                        <br>
                        訂單狀態：<asp:DropDownList ID="DropDownList_Status" runat="server"></asp:DropDownList>
                        <br>
                        <br>
