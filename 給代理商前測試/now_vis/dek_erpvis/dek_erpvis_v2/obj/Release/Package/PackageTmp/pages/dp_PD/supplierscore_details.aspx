<%@ Page Title="" Language="C#" MasterPageFile="~/masterpage.Master" AutoEventWireup="true" CodeBehind="supplierscore_details.aspx.cs" Inherits="dek_erpvis_v2.pages.dp_PD.supplierscore_details" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script>
        //產生表格的HTML碼
        create_tablecode('supplierscore_details', '<%=sup_sname %>達交率明細表', 'datatable-buttons', '<%=th%>', '<%=tr%>');
        //產生相對應的JScode
