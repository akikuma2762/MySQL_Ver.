<%@ Page Title="" Language="C#" MasterPageFile="~/masterpage.Master" AutoEventWireup="true" CodeBehind="Set_highpower.aspx.cs" Inherits="dek_erpvis_v2.pages.SYS_CONTROL.Set_highpower" %>
    ...
    <div class="right_col" role="main">
        <div class="row">
            ...
            <div class="col-md-6 col-sm-12 col-xs-12" style="padding-left: 5px">
                <div class="x_panel" id="Div_Shadow">
                    <div class="x_title" style="text-align: center;">
                        <div style="display:none" ><b>群組選擇</b></div>
                        ...
                        <asp:Button ID="Button_dpm" runat="server" Text="新增群組" OnClick="Button_dpm_Click" class="btn btn-primary antosubmit2" style="display:none" />
