<%@ Page Title="" Language="C#" MasterPageFile="~/masterpage.Master" AutoEventWireup="true" CodeBehind="Asm_PersonNoFinish.aspx.cs" Inherits="dek_erpvis_v2.pages.dp_PM.Asm_PersonNoFinish" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>問題未結案列表 | <%= WebUtils.GetAppSettings("Company_Name") %></title>
    <%=color %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="right_col" role="main" style="height: 930px;">
        ...
        <!-----------------/title------------------>
        <!-----------------content------------------>
        <div id="Asm_PersonNoFinish"></div>
        <!-----------------/content------------------>
    </div>
    <%=Use_Javascript.Quote_Javascript() %>
    <script>
        //產生表格的HTML碼
        create_tablecode('Asm_PersonNoFinish', '未結案問題', 'datatable-buttons', '<%=th%>', '<%=tr%>');
        //產生相對應的JScode
