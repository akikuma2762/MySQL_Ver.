<%@ Page Title="" Language="C#" MasterPageFile="~/masterpage.Master" AutoEventWireup="true" CodeBehind="Asm_PersonFinish_Detail.aspx.cs" Inherits="dek_erpvis_v2.pages.dp_PM.Asm_PersonFinish_Detail" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title><%=staff %>問題已結案列表 | <%= WebUtils.GetAppSettings("Company_Name") %></title>
    <%=color %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="right_col" role="main" style="height: 930px;">
     ...
     <%=path %>
        ...
        <!-----------------/title------------------>
        <!-----------------content------------------>
        <div id="Asm_PersonFinish_Detail"></div>
        <!-----------------/content------------------>
    </div>
      <%=Use_Javascript.Quote_Javascript() %>
    <script>
        //產生表格的HTML碼
        create_tablecode('Asm_PersonFinish_Detail', '<%=staff %>問題已結案', 'datatable-buttons', '<%=th%>', '<%=tr%>');
        //產生相對應的JScode
